...
class TRPOLoss(object):
    def __init__(self,
                 ...
                 vf_loss_coeff=1.0,
                 use_gae=True):
        """Constructs the loss for Trust Region Policy Objective.
...
class TRPOPostprocessing(object):
...
class TRPOPolicyGraph(LearningRateSchedule, TRPOPostprocessing, TFPolicyGraph):
    def __init__(self,
                 observation_space,
                 action_space,
                 config,
